  ...
  const frameHtml = `
    ...
    <html>
      <head>
        ...
        <meta property="fc:frame:post_url" content="https://claim-token-godmode.netlify.app/api/frame" />
      ...
      <body style="margin: 0; padding: 0; font-family: Arial, sans-serif; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); min-height: 100vh; display: flex; align-items: center; justify-content: center; color: white;">
        <div style="text-align: center; padding: 40px;">
          ...
          <a href="https://claim-token-godmode.netlify.app/app.html" style="display: inline-block; margin-top: 30px; padding: 20px 60px; background: linear-gradient(135deg, #ffd700, #ffed4e); color: #000; text-decoration: none; border-radius: 16px; font-size: 24px; font-weight: 900;">🚀 LAUNCH MINT APP</a>
        </div>
      </body>
    </html>
  `;
